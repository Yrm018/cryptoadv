...
class _ChiffrementMobileState extends State<ChiffrementMobile> {
  ...
  Future<void> _saveHistory({required String inputPreview, required String result}) async {
    ...
    await _historyService.addHistoryItem(userId: user.uid, type: 'cipher', algorithm: algoLabel, inputPreview: inputPreview.length > 50 ? '${inputPreview.substring(0, 50)}...' : inputPreview, result: result, isEncrypted: true);
  }
